...
namespace SIM_PART
{
	const std::string LabWorkCGAL::_shaderFolder = "src/lab_works/lab_work_cgal/shaders/";
	float			  distance_orbite		  = 7.f;

	LabWorkCGAL::~LabWorkCGAL() { glDeleteProgram( _program ); }

	bool LabWorkCGAL::init()
	{
		std::cout << "Initializing lab work cgal..." << std::endl;
		...
		_cube2._transformation = glm::translate( _cube2._transformation, glm::vec3( distance_orbite, 0.f, 0.f ) );
	...
	void LabWorkCGAL::handleEvents( const SDL_Event & p_event )
	{
	...
	void LabWorkCGAL::displayUI()
	{
		ImGui::Begin( "Settings lab work cgal" );
	...
	void LabWorkCGAL::resize( const int p_width, const int p_height )
	{
		BaseLabWork::resize( p_width, p_height );
		_camera->setScreenSize( p_width, p_height );
	}

	bool LabWorkCGAL::_initProgram()
	{
		// ====================================================================
		// Shaders.
		// ====================================================================
	...
	void LabWorkCGAL::_initBuffersCube( Mesh * cube )
	{
		/*//Vertices
